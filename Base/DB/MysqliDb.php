...
class MysqliDb
{
    ...
    */
    ...
    {
        $stmt = $this->mysqli()->multi_query($query);

        // Failed?
        if(!$stmt){
            throw new \Exception("multiQuery Query Failed, ERRNO: ".$this->mysqli()->errno." (".$this->mysqli()->error.")", $this->mysqli()->errno);
        };
        ...
        $return_val = $ret ? $return_val : $stmt;
        return $return_val;
    }
